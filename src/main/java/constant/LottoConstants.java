...
public class LottoConstants {
    ...
    public static final String ERROR_NUMBER_RANGE = "[ERROR] 숫자는 " + NUMBER_LOWER_BOUND + "부터 " + NUMBER_UPPER_BOUND + " 사이의 숫자여야 합니다.";
    ...
    public static final String ERROR_NOT_ENOUGH_MONEY = "[ERROR] 단 한개의 로또도 구매 할 수 없습니다.";
}
